...
local KnownOffsets = {
    ["AnimationId"] = getOffset(offsets, "Misc", "AnimationId") or getOffset(offsets, "AnimationTrack", "AnimationId") or 0xC8,
    ["ClassDescriptor"] = getOffset(offsets, "Instance", "ClassDescriptor") or 0x18,
    ["ClassDescriptorToClassName"] = getOffset(offsets, "Instance", "ClassName") or 0x8,
    ["Name"] = getOffset(offsets, "Instance", "Name") or 0x48,
    ["TimePosition"] = getOffset(offsets, "AnimationTrack", "TimePosition") or 0x68,
    ["ActiveAnimations"] = getOffset(offsets, "Animator", "ActiveAnimations") or 0x278,
    ["Animation"] = getOffset(offsets, "AnimationTrack", "Animation") or 0xD0,
    ["Speed"] = getOffset(offsets, "AnimationTrack", "Speed") or 0x64,
    ["IsPlaying"] = getOffset(offsets, "AnimationTrack", "IsPlaying") or 0x90,
    ["NodeNext"] = 0x10,
}
